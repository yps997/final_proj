...
class Event(Base):
    ...
    def __repr__(self):
        return (f"<Event(id={self.id}, kill_number={self.kill_number}, wound_number={self.wound_number},"
                f" terror_group={self.terror_group}, killers_number={self.killers_number},"
                f" is_suicide={self.is_suicide})>")